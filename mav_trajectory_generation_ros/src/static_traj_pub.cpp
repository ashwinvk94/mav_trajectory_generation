...
int main(int argc, char **argv)
{
    ...
    {   
        ...
        start.makeStartOrEnd(Eigen::Vector3d(1,0,1), derivative_to_optimize);
		vertices.push_back(start);

		middle.addConstraint(mav_trajectory_generation::derivative_order::POSITION, Eigen::Vector3d(0,0.5,1));
		...
		end.makeStartOrEnd(Eigen::Vector3d(1,2.5,1), derivative_to_optimize);
